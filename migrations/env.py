...
This migration setup was adopted after `tours`, `venues`, and `concerts`
already existed via `Base.metadata.create_all` at application startup;
those tables are intentionally left out of the migration history here.
`lineup_entries` is the first table managed by Alembic.
"""
